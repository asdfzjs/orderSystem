...
<body>
	<form method="post" action="searchSendOrder.do" id="listform">
			                ...
			                <c:if test="${pages != 1}">  
			                    <c:forEach var="pageIndex" begin="1" end="${pages}">  
			                         <c:choose>  
			                            ...
			                            <c:otherwise>  
			                                <a href="searchSendOrder.do?page=${pageIndex}">${pageIndex}</a>  
			                             </c:otherwise>  
			                        </c:choose>  
			                    </c:forEach>  
			                </c:if>  
			                <c:if test="${pageNum != pages}">  
			                    <a href="searchSendOrder.do?page=${pageNum+1}">下一页</a>  
			                </c:if>  
			            </td>  
			        </tr>  
			            </div>
