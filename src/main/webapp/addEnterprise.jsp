...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x" action="addProduct.do">
				<div class="form-group">
					<table border=0 cellspacing=0 cellpadding=0>
						...
						<tr>
							...
							<td>
								<div class="field">
									<input type="text" class="input" name="contact" value="" />
									<div class="tips"></div>
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="field">
									<input type="text" class="input" name="fax" value="" />
									<div class="tips"></div>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="field">
									<input type="text" class="input" name="mem_id" value="" />
									<div class="tips"></div>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
							<div class="field">
									<input class="input" name="startdate" type="text" onClick="WdatePicker()">
							</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td><div class="field">
									<input class="input" type="text" name="enddate" onClick="WdatePicker()"></div>
							</td>
						</tr>
						<tr>
